...
public abstract interface IGameObject {
	...
	public abstract Iterator<Map.Entry<String, GameDataWrapper>> iterator();
	...
	public abstract GameDataWrapper get(String paramString);
	...
	public abstract IGameArray getGameArray(String paramString);

	public abstract IGameObject getGameObject(String paramString);
	...
	public abstract void putGameArray(String paramString, IGameArray paramIGameArray);

	public abstract void putGameObject(String paramString, IGameObject paramIGameObject);

	public abstract void putClass(String paramString, Object paramObject);

	public abstract void put(String paramString, GameDataWrapper paramGameDataWrapper);
}